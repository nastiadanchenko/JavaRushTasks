...
import com.javarush.task.task39.task3913.s4.Event;
...
public interface EventQuery {
    ...
    Set<com.javarush.task.task39.task3913.s4.Event> getEventsForIP(String ip, Date after, Date before);

    Set<com.javarush.task.task39.task3913.s4.Event> getEventsForUser(String user, Date after, Date before);

    Set<com.javarush.task.task39.task3913.s4.Event> getFailedEvents(Date after, Date before);

    Set<com.javarush.task.task39.task3913.s4.Event> getErrorEvents(Date after, Date before);
